...
- 2026-07-13: verified artifact `artifacts/mp/20260713-075357-two-humanbot-two-ai-smoke/result.json`
- 2026-07-13: verified artifact `artifacts/mp/20260713-085009-two-humanbot-two-ai-smoke/result.json`
- 2026-06-09: 2 HumanBot + 2 AI headless smoke PASS with playerCount=4 humanCount=2 aiCount=2, comparisonSuccess=true, cleanupStatus=PASS, orphanedPids=[].
- 2026-06-09: verified artifact `artifacts/mp/20260609-024600-two-humanbot-two-ai-smoke/result.json`
- 2026-06-09: Verified 2 HumanBot + 2 AI bounded 3-round progression kept playerCount=4 humanCount=2 aiCount=2 with comparisonSuccess=true, cleanupStatus=PASS, orphanedPids=[].
- 2026-06-09: verified artifact `artifacts/mp/20260609-032334-two-humanbot-two-ai-smoke/result.json`
- 2026-06-12: verified artifact `artifacts/program-stability/20260612-052803-two-humanbot-two-ai-smoke/result.json`
- 2026-07-15: Launching a visible two-build run with both real peers controlled by HumanBot and two server AI fill slots.
- 2026-07-15: Visible two-build run verified 2 HumanBot real peers plus 2 AI fill, comparison PASS and clean shutdown.
- 2026-07-15: verified artifact `artifacts/mp/20260715-035915-two-humanbot-two-ai-smoke/result.json`
- 2026-07-15: Repeating the visible two-HumanBot build run for live user observation.
- 2026-07-15: Repeated visible 2-HumanBot run passed with comparisonSuccess and clean shutdown.
- 2026-07-15: verified artifact `artifacts/mp/20260715-040340-two-humanbot-two-ai-smoke/result.json`

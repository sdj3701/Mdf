...
Verified by: see Verification section below; migrated from old Status: verified-from-repo; Mdfproject; artifacts/singleplayer-breakwall-addressables-latest.log; unity-cli --project Mdfproject status => ready; editor refresh --compile => Compilation complete; console errors => []; console --type error => []; unity-cli --project Mdfproject editor refresh --compile => Compilation complete; unity-cli --project E:/UnityProjects/mdf/Mdfproject editor refresh --compile --force => Compilation complete; unity-cli --project E:/UnityProjects/mdf/Mdfproject status => ready; editor refresh --compile --force => Compilation complete; reserialize character prefabs/test scene; unity-cli status ready; refresh --compile --force; console errors []; reserialize test scene and UnitData assets; reserialize Assets/Scenes/test.unity; final console errors []; reserialize Assassin UnitData/test scene; unity-cli --project Mdfproject status; editor refresh --compile; console --type error --stacktrace user; EditMode 98/98; console --clear; unity-cli --project Mdfproject compile/console/EditMode 98/98 after projectile preview duplicate guard; unity-cli --project Mdfproject refresh/console/EditMode after projectile VFX renderer occlusion guard; unity-cli --project Mdfproject refresh/console/EditMode 98/98 after projectile VFX occlusion and sorting guard; unity-cli --project Mdfproject status ready; editor refresh --compile PASS; compile PASS; console []; unity-cli --project Mdfproject status/compile/console/EditMode 107 passed on 2026-05-31; unity-cli --project Mdfproject status/compile/console/EditMode 109 passed on 2026-05-31; unity-cli --project Mdfproject status/compile/console/EditMode 109 passed on 2026-05-31 pending-active-slot; artifacts/mp/20260531-044835-matrix/20260531-044847-network-budget-pending-stress/post-battle-host-migration-result.json; artifacts/mp/20260531-052919-matrix/20260531-052924-status-effect-host-migration/post-battle-host-migration-result.json; artifacts/mp/20260531-061353-matrix/20260531-061359-network-budget-pending-stress/post-battle-host-migration-result.json; artifacts/mp/20260531-063526-matrix/20260531-063541-network-budget-pending-stress/post-battle-host-migration-result.json; unity-cli --project Mdfproject status/compile/console/EditMode 110 passed on 2026-05-31; Mdfproject
Replacement: none
...
- 2026-07-12: verified artifact `Mdfproject`
...
- 2026-07-15: verified artifact `Mdfproject`
